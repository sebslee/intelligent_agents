...
public class Agent26v2 extends AbstractNegotiationParty {

	private final String description = "Agent 26v2";
	...
	private Bid generateNashBid(){
		...
		double T , T_old,  kmax , curr_energy , next_energy , our_utility, predicted_b , predicted_a , a , b;
		Bid altered_bid;
